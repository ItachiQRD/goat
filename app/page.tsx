    ...
    <div ref={containerRef} className="min-h-screen bg-[#151515] text-white overflow-x-hidden relative">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <ScrollReveal>
            <div className="mb-8 flex items-center gap-4">
              <span className="text-lg italic opacity-60">01</span>
              <div className="h-px flex-1 bg-gradient-to-r from-white/30 to-transparent" />
              <span className="text-xs uppercase tracking-widest text-white/60">Pourquoi un bon site web ?</span>
            </div>
            <div className="max-w-4xl mb-20">
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-light leading-[0.95] tracking-tight mb-8">
                <SplitText>Votre site, c'est votre</SplitText>
                <span className="block bg-gradient-to-r from-[#3b82f6] via-[#8b5cf6] to-[#ff6b35] bg-clip-text text-transparent mt-2">
                  meilleur commercial
                </span>
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                stat: '75%',
                label: 'des utilisateurs jugent la crédibilité d\'une entreprise sur son site',
                color: 'from-blue-500/20 to-cyan-500/20',
                icon: '🎯',
              },
              {
                stat: '3s',
                label: 'maximum pour qu\'un visiteur attende avant de partir',
                color: 'from-yellow-500/20 to-orange-500/20',
                icon: '⏱️',
              },
              {
                stat: '60%',
                label: 'du trafic web mondial se fait depuis un mobile',
                color: 'from-purple-500/20 to-pink-500/20',
                icon: '📱',
              },
              {
                stat: '×7',
                label: 'plus de visibilité avec un bon référencement Google',
              ...
              >
                <div className={`relative h-full p-6 md:p-8 rounded-2xl backdrop-blur-xl bg-gradient-to-br ${item.color} border border-white/10 group-hover:border-white/30 transition-all duration-500 overflow-hidden`}>
                  <div
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-5xl md:text-6xl font-extrabold mb-3 bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">
                      {item.stat}
                    </div>
      ...
      <section className="py-32 px-6 relative overflow-hidden" id="services">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <ScrollReveal>
            <div className="mb-8 flex items-center gap-4">
              <span className="text-lg italic opacity-60">02</span>
              <div className="h-px flex-1 bg-gradient-to-r from-white/30 to-transparent" />
              <span className="text-xs uppercase tracking-widest text-white/60">Mes services</span>
            </div>
            <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-8 gap-8">
              <div className="space-y-4 max-w-3xl">
                <h2 className="text-5xl md:text-7xl lg:text-8xl font-light leading-[0.95] tracking-tight">
                  ...
                  <span className="block text-white/60 mt-2">pour vous</span>
                </h2>
                <p className="text-lg md:text-xl text-white/70 font-light leading-relaxed mt-6">
                  Chaque carte se lit dans deux langues : <span className="text-white font-medium">"Pour vous"</span> si 
                  vous voulez comprendre ce que vous obtenez, <span className="text-white font-medium">"Tech"</span> si 
                  vous voulez voir les technologies derrière.
                </p>
              </div>
            </div>
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 mb-12 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs text-white/70"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
              </svg>
              <span>Cliquez sur les onglets en haut à droite des cartes pour basculer</span>
            </motion.div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <DualCard
              ...
              illustration={<ModernIllustration type="visibility" />}
              benefit={{
                headline: 'Soyez trouvé sur Google',
                description:
                  'Un site qui présente votre activité, capte vos visiteurs et les transforme en prospects qualifiés.',
                points: [
              ...
              technical={{
                ...
                description:
                  'Architecture statique/SSR optimisée pour les Core Web Vitals et le crawl Google.',
            ...
            <DualCard
              ...
              illustration={<ModernIllustration type="shop" />}
              benefit={{
                headline: 'Vendez 24h/24, partout',
                description:
                  'Une boutique en ligne complète et facile à gérer pour développer votre chiffre d\'affaires.',
                points: [
              ...
              technical={{
                ...
                description:
                  'Stack performante avec Stripe, gestion d\'inventaire en temps réel et webhooks.',
            ...
            <DualCard
              ...
              illustration={<ModernIllustration type="analytics" />}
              benefit={{
                headline: 'Automatisez votre quotidien',
                description:
                  'Un outil sur-mesure qui remplace vos Excel et fait gagner des heures à votre équipe.',
                points: [
              ...
              technical={{
                ...
                description:
                  'Application web sécurisée avec rôles, permissions, API REST/GraphQL et webhooks.',
            ...
            <DualCard
              ...
              illustration={<ModernIllustration type="mobile" />}
              benefit={{
                headline: 'Beau sur tous les écrans',
                description:
                  'Smartphone, tablette, ordinateur : votre site s\'adapte parfaitement à chaque appareil.',
                points: [
              ...
              technical={{
                ...
                description:
                  'Approche mobile-first avec breakpoints fluides, lazy loading et optimisations images.',
            ...
            <DualCard
              ...
              illustration={<ModernIllustration type="security" />}
              benefit={{
                headline: 'Vos données sont en sécurité',
                description:
                  'Conformité RGPD, certificat SSL, sauvegardes automatiques. Vous dormez tranquille.',
                points: [
              ...
              technical={{
                ...
                description:
                  'Authentification robuste, protection CSRF/XSS, audit de sécurité, headers HTTP stricts.',
            ...
            <DualCard
              ...
              illustration={<ModernIllustration type="design" />}
              benefit={{
                headline: 'Une identité unique'
                ,
                description:
                  'Pas de template recyclé. Un design pensé pour votre marque, vos couleurs, votre univers.',
                points: [
              ...
              technical={{
                ...
                description:
                  'Framer Motion, GSAP, WebGL avec Three.js. Performance maintenue grâce au GPU.',
            ...
            <div className="mt-16 text-center">
              <Link href="/services" data-cursor-hover>
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-white/5 backdrop-blur-md border border-white/20 hover:bg-white/10 hover:border-white/40 transition-all"
                >
                  <span className="text-base font-light">Voir tous les services en détail</span>
      ...
      {/* ====== POUR QUI ? ====== */}
      <section className="py-32 px-6 relative overflow-hidden" id="pour-qui">
        <ParallaxBackground speed={0.3}>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <ScrollReveal>
            <div className="mb-8 flex items-center gap-4">
              <span className="text-lg italic opacity-60">03</span>
              <div className="h-px flex-1 bg-gradient-to-r from-white/30 to-transparent" />
              <span className="text-xs uppercase tracking-widest text-white/60">Pour qui je travaille</span>
            </div>
            <div className="max-w-4xl mb-16">
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-light leading-[0.95] tracking-tight mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {audiences.map((audience, i) => (
              <motion.div
                ...
                className="group relative"
              >
                <div className="relative h-full p-7 rounded-2xl backdrop-blur-xl bg-white/[0.03] border border-white/10 hover:border-white/30 hover:bg-white/[0.06] transition-all duration-500 overflow-hidden">
                  {/* Ligne décorative */}
                  <motion.div
                  ...
                  <div className="relative z-10">
                    <div className="text-5xl mb-5">{audience.emoji}</div>
                    <h3 className="text-xl md:text-2xl font-medium mb-3">{audience.title}</h3>
                    <p className="text-sm md:text-base text-white/70 leading-relaxed mb-5 font-light">
                      {audience.desc}
                    </p>
      ...
      {/* ====== COMMENT ÇA SE PASSE ====== */}
      <section className="py-32 px-6 relative overflow-hidden" id="processus">
        <ParallaxBackground speed={0.4}>
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#3b82f6]/5 to-transparent" />
        </ParallaxBackground>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <ScrollReveal>
            <div className="mb-8 flex items-center gap-4">
              <span className="text-lg italic opacity-60">04</span>
              <div className="h-px flex-1 bg-gradient-to-r from-white/30 to-transparent" />
              <span className="text-xs uppercase tracking-widest text-white/60">Comment ça se passe</span>
            </div>
            <div className="max-w-4xl mb-20">
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-light leading-[0.95] tracking-tight mb-6">
                <SplitText>De l'idée au site,</SplitText>
                <span className="block bg-gradient-to-r from-white to-[#3b82f6] bg-clip-text text-transparent mt-2">
                  en 4 étapes simples
                </span>
              </h2>
              <p className="text-lg md:text-xl text-white/70 font-light leading-relaxed">
                Pas de jargon, pas de surprise. Vous savez exactement ce qui se passe, quand, et combien ça coûte. 
                Transparence totale du début à la fin.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <motion.div
              className="absolute left-8 md:left-1/2 top-0 bottom-0 w-1 -ml-0.5 bg-gradient-to-b from-[#3b82f6] via-[#8b5cf6] to-[#ff6b35]"
              initial={{ scaleY: 0 }}
                  ...
                  >
                    ...
                    <div className="relative z-10 flex-shrink-0">
                      <motion.div
                        ...
                        className="relative w-16 h-16 md:w-20 md:h-20 rounded-2xl bg-gradient-to-br from-[#3b82f6] to-[#8b5cf6] flex items-center justify-center shadow-[0_10px_30px_rgba(59,130,246,0.4)]"
                      >
                    ...
                    <div className={`flex-1 md:max-w-xl ${isLeft ? 'md:text-left' : 'md:text-right'}`}>
                      <div className="relative p-6 md:p-8 rounded-2xl backdrop-blur-xl bg-white/[0.04] border border-white/10 hover:border-white/30 transition-all">
                        <div className={`flex flex-wrap items-center gap-3 mb-4 ${isLeft ? '' : 'md:justify-end'}`}>
                          <h3 className="text-2xl md:text-3xl font-light">{step.title}</h3>
                          <span className="text-xs px-3 py-1 rounded-full bg-[#3b82f6]/20 border border-[#3b82f6]/30 text-[#60a5fa]">
                            ⏱ {step.duration}
                          </span>
                        </div>
                        <p className="text-base md:text-lg text-white/70 leading-relaxed mb-5 font-light">
                          {step.simple}
                        </p>
                        <div className={`flex flex-wrap gap-2 ${isLeft ? '' : 'md:justify-end'}`}>
                          {step.deliverables.map((item, j) => (
                            <span
                              key={j}
                              className="text-xs px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-white/80 flex items-center gap-1.5"
                            >
                    ...
                    {/* Espace côté opposé pour aligner */}
      ...
      {/* ====== STACK TECHNIQUE - Reformulée ====== */}
      <section className="py-32 px-6 relative overflow-hidden" id="stack">
        <ParallaxBackground speed={0.4}>
          <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#8b5cf6]/5 to-transparent" />
        </ParallaxBackground>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <ScrollReveal>
            <div className="mb-8 flex items-center gap-4">
              <span className="text-lg italic opacity-60">05</span>
              <div className="h-px flex-1 bg-gradient-to-r from-white/30 to-transparent" />
              <span className="text-xs uppercase tracking-widest text-white/60">Sous le capot</span>
            </div>
            <div className="max-w-4xl mb-20">
              <h2 className="text-5xl md:text-7xl lg:text-8xl font-light leading-[0.95] tracking-tight mb-6">
                <SplitText>Les outils qui</SplitText>
                <span className="block bg-gradient-to-r from-[#8b5cf6] to-[#ff6b35] bg-clip-text text-transparent mt-2">
                  font la différence
                </span>
              </h2>
              <p className="text-lg md:text-xl text-white/70 font-light leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {techCategories.map((cat, i) => (
              <motion.div
                ...
                className="group relative"
              >
                <div className={`relative h-full p-8 rounded-3xl backdrop-blur-xl bg-gradient-to-br ${cat.gradient} border border-white/10 group-hover:border-white/30 transition-all duration-500 overflow-hidden`}>
                  {/* Glow */}
                  <div
                  ...
                  <div className="relative z-10">
                    ...
                    {/* Séparateur */}
                    <div className="h-px bg-gradient-to-r from-white/20 to-transparent mb-5" />
                    ...
                    <div className="flex flex-wrap gap-2">
                      {cat.techs.map((tech, j) => (
                        <motion.span
                          ...
                          className="px-3 py-1.5 rounded-lg text-xs font-mono bg-black/30 border border-white/10 text-white/80 backdrop-blur-sm cursor-default"
                        >
                          {tech}
                        </motion.span>
                      ))}
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <ScrollReveal>
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-6xl lg:text-7xl font-light leading-tight mb-6">
                Des résultats
            ...
            {[
              {
                ...
                desc: 'Performance Google maximale',
              ...
              },
              {
                ...
                desc: 'Plus rapide que 90% des sites',
              ...
              },
              {
                ...
                suffix: '%',
                label: 'Disponibilité',
                desc: 'Site en ligne 24h/24, 365j/an',
              ...
              },
              {
                ...
                suffix: '%',
                label: 'Sur-mesure',
                desc: 'Aucun template, tout est unique',
              ...
              <motion.div
                ...
                className="group relative"
              >
                <div className="relative p-6 md:p-8 rounded-3xl backdrop-blur-xl bg-white/[0.03] border border-white/10 hover:border-white/30 transition-all overflow-hidden text-center">
                  {/* Halo */}
                  <div className={`absolute inset-0 bg-gradient-to-br ${stat.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500`} />

                  <div className="relative z-10">
                    <div className={`text-5xl md:text-6xl lg:text-7xl font-extrabold mb-3 bg-gradient-to-r ${stat.color} bg-clip-text text-transparent`}>
                      <AnimatedCounter
                        value={stat.value}
                        suffix={stat.suffix}
                    ...
                    <div className="text-xs md:text-sm text-white/60 font-light">
                      {stat.desc}
                    </div>
                  </div>
                </div>
          ...
          <ScrollReveal delay={0.3}>
            <div className="mt-20 max-w-4xl mx-auto">
              <div className="p-8 md:p-12 rounded-3xl backdrop-blur-xl bg-gradient-to-br from-white/[0.04] to-white/[0.02] border border-white/10">
                <h3 className="text-2xl md:text-3xl font-light text-center mb-10">
                  ...
                  {[
                    ...
                    <div key={i} className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm md:text-base text-white/80">{row.label}</span>
                      </div>
                      {/* Site classique */}
                      <div className="relative">
                        <div className="absolute -top-5 left-0 text-xs text-white/50">Site classique</div>
                      ...
                      <div className="relative pt-4">
                        <div className="absolute -top-1 left-0 text-xs text-[#60a5fa] font-medium">Mes sites</div>
                        <div className="h-3 rounded-full bg-white/5 overflow-hidden">
                          <motion.div
                            initial={{ width: 0 }}
      ...
      {/* ====== À PROPOS - Refonte humaine ====== */}
      <section className="py-32 px-6 relative overflow-hidden" id="a-propos">
        <ParallaxBackground speed={0.5}>
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#8b5cf6]/5 to-transparent" />
          </div>
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <ScrollReveal>
            <div className="mb-8 flex items-center gap-4">
              <span className="text-lg italic opacity-60">06</span>
              <div className="h-px flex-1 bg-gradient-to-r from-white/30 to-transparent" />
              <span className="text-xs uppercase tracking-widest text-white/60">À propos</span>
            </div>
          </ScrollReveal>
            ...
            <ScrollReveal direction="left">
              <div className="relative aspect-square max-w-md mx-auto">
                ...
                {[1, 2, 3].map((i) => (
                  ...
                  >
                    {/* Petits éléments sur les cercles */}
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    className="relative w-40 h-40 md:w-48 md:h-48 rounded-3xl bg-gradient-to-br from-[#3b82f6] via-[#8b5cf6] to-[#ff6b35] flex items-center justify-center text-7xl shadow-[0_20px_60px_rgba(59,130,246,0.4)]"
                  >
                    <span>👨‍💻</span>
                    {/* Statut en ligne */}
                    <div className="absolute -bottom-2 -right-2 px-3 py-1.5 rounded-full bg-green-500 text-white text-xs font-medium shadow-lg flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  {[
                    ...
                    >
                      ...
                      <div className="font-medium mb-0.5">{val.title}</div>
                      <div className="text-xs text-white/60">{val.desc}</div>
                    </motion.div>
                  ))}
                </div>
              </div>
          ...
          {/* Tech tags - Carousel infini horizontal */}
          <ScrollReveal delay={0.3}>
              ...
              <div className="overflow-hidden relative">
                ...
                >
                  {[
                    ...
                    <div
                      key={i}
                      className="flex-shrink-0 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-sm font-mono text-white/80"
                    >
                      {tech}
                    </div>
                  ))}
                ...
                {/* Fades */}
                <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#151515] to-transparent pointer-events-none" />
                <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#151515] to-transparent pointer-events-none" />
              </div>
            </div>
          </ScrollReveal>
        </div>
      ...
      <section className="py-32 px-6 relative overflow-hidden" id="contact">
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <ScrollReveal>
            <div className="mb-8 flex items-center gap-4">
              <span className="text-lg italic opacity-60">07</span>
              <div className="h-px flex-1 bg-gradient-to-r from-white/30 to-transparent" />
              <span className="text-xs uppercase tracking-widest text-white/60">On en parle ?</span>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-white/70 font-light max-w-2xl mx-auto leading-relaxed mb-10">
                ...
                <span className="block mt-2 text-white">Le premier échange est toujours gratuit.</span>
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/contact" data-cursor-hover>
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="group relative px-10 py-5 bg-gradient-to-r from-[#3b82f6] to-[#8b5cf6] text-white rounded-full text-lg font-semibold shadow-[0_10px_40px_rgba(59,130,246,0.4)] hover:shadow-[0_20px_60px_rgba(59,130,246,0.6)] transition-all overflow-hidden"
                  >
                ...
                <Link href="/tarification" data-cursor-hover>
                  <motion.div
                    whileHover={{ scale: 1.05, y: -3 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-10 py-5 bg-white/5 backdrop-blur-md border border-white/20 text-white rounded-full text-lg font-light hover:bg-white/10 hover:border-white/40 transition-all"
                  >
                    Voir les tarifs
                  </motion.div>
                </Link>
            ...
            {[
              ...
              >
                <Link href={card.href} className="block h-full" data-cursor-hover>
                  <div className={`relative h-full p-8 rounded-3xl backdrop-blur-xl bg-gradient-to-br ${card.gradient} border border-white/10 group-hover:border-white/30 transition-all duration-500 overflow-hidden`}>
                    <div
                      className="absolute -top-20 -right-20 w-40 h-40 rounded-full blur-3xl opacity-30 group-hover:opacity-60 transition-opacity"
                      style={{ background: 'radial-gradient(circle, rgba(255,255,255,0.4), transparent 70%)' }}
                    />
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center gap-2 text-sm font-medium text-white border-t border-white/10 pt-4">
          ...
          <ScrollReveal delay={0.4}>
            <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[
                ...
                { icon: '✓', label: 'Transparence totale' },
              ].map((item, i) => (
                <motion.div
                  key={i}
                  initial={{ opacity: 0, scale: 0.8 }}
                  ...
                  className="flex items-center justify-center gap-2 px-4 py-3 rounded-full bg-white/5 border border-white/10 text-sm text-white/80"
                >
